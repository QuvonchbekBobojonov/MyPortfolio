...
function Contact() {
    ...
    const SendToTelegram = (fullName, email, phoneNumber, subject, budget, message) => {
        ...
        const url = `https://api.telegram.org/bot${token}/sendMessage?chat_id=${chatId}&text=Name: ${fullName}%0AEmail: ${email}%0APhone: ${phoneNumber}%0ASubject: ${subject}%0ABudget: ${budget}%0AMessage: ${message}`;
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-12">
                                <div className="input-group">
                                    ...
                                    <input type="number" name="budget" id="budget" placeholder="Enter your budget for the project"/>
                                </div>
                            </div>
                            <div className="col-md-12">
                                <div className="input-group">
