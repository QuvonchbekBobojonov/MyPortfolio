    ...
    return (
        <div className="left-sidebar">
            ...
            <ul className="social-profile d-flex align-items-center flex-wrap justify-content-center">
                ...
                <li>
                    <a href="https://t.me/+998774040066" target='_blank' rel="noreferrer"><i className="lab la-telegram"></i></a>
                </li>
                <li>
                    <a href="https://instagram.com/quvonchbekdev" target='_blank' rel="noreferrer"><i className="lab la-instagram"></i></a>
                </li>
                <li>
